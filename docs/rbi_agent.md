...
STRATEGIES_FOLDER = "/Users/md/Dropbox/dev/github/moon-dev-ai-agents/src/data/web_search_research/final_strategies"
```
...
DATA_DIR = "/Users/md/Dropbox/dev/github/moon-dev-ai-agents/src/data/rbi"

# CSV file with strategy ideas (classic mode only)
IDEAS_FILE = "/Users/md/Dropbox/dev/github/moon-dev-ai-agents/src/data/rbi_pp_multi/ideas.txt"
```
...
**GitHub**: https://github.com/moon-dev/moon-dev-ai-agents
